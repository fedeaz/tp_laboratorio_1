...
int factorial (int op1) /**< solicita 1 numero al usuario y devuelve como resultado el factorial de este */
    {
        ...
        for(i = 1; i <= op1 ; i++)     /*se crea la interación*/ /* se le asigna a i el valor 1*/ /*el for se va a ejecutar mientras i no sea mayor o igual a el operador 1*/ /*se le suma 1 a i*/
            {
